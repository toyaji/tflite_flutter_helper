...
class TensorImage {
  ...
  final dynamic _tfLiteType;

  /// Initialize a [TensorImage] object.
  ///
  /// Note: For Image with float value pixels use [TensorImage('float32')]
  TensorImage([dynamic dataType = 'uint8']) : _tfLiteType = dataType;
  ...
  ///
  /// Currently only 'uint8' and 'float32' are possible.
  dynamic getDataType() => dataType;

  /// Gets the current data type.
  ///
  /// Currently only 'uint8' and 'float32' are possible.
  dynamic get tfLiteType {
    return _tfLiteType;
  }
